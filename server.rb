...
before do
	@products = {
		...
		product_name6:{name: "productName6", image: "/images/QA-Danny-DeVito-008.jpg", description: "product description 2 goes here", hook: "Heyhhhhhhhhhhhhhh mami' check me out", categories: ["category2"]},
