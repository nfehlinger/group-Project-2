...
before do
	@products = {
		...
		wine_picnic:{name: "Wine Picnic", image: "/images/cocktailPicnic", description: "When it's time for a cocktail and also time for a trip to the out of doors: Maybe it's time for both. Out doors and also picnics. make it heavy and real" 
			
		end", hook: "Heyhhhhhhhhhhhhhh mami' check me out", categories: ["category2"]},
		product_name7:{name: "productName7", image: "/images/QA-Danny-DeVito-008.jpg", description: "product description 2 goes here", hook: "Hey ttttttttttttami' check me out", categories: ["category3"]},
